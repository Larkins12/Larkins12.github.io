(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.steve, 300, 190, 9, 1.0);
        collectable.create(type.grace,600, 200, 3, 3.0);
        collectable.create(type.kennedi,900, 600,5, 3.0);
        collectable.create(type.max, 800, 400, 4, 2.5);
